...
const PANEL = [
  ...
  ['s','tent_ridge_h_m','crown h (m)',0.4,3,0.05,''],     // the enclosure's polytope (receiver 'tent'): crown plane, slope run, crown flat, length, gable lean
  ...
  ['s','tent_shoulder_h_m','shoulder h (m)',0.1,2.5,0.01,''],   // the bell's crease; clamped into [0.15,0.9]x crown height
  ['s','tent_shoulder_w_m','shoulder w (m)',0.2,3,0.01,''],     // clamped UP to the straight base->crown line: below it the profile dents and the skirt would slice the crown off
  ['s','tent_len_m','length (m)',0.8,8,0.1,''],
  ['s','tent_end_lean','gable lean',0,2,0.02,''],
  ['s','tent_gable_bevel','gable bevel',0,1.2,0.01,''],   // 0 = one flat end wall, bit-exactly
...
const TIPS = {
  ...
  tent_shoulder_h_m:"<b>How high the fold runs along each side wall.</b> Below it the wall flares out into the skirt; above it the wall leans back in toward the ceiling. Low = a tall leaning upper wall over a short skirt; high = the fold up near the ceiling and the wall almost straight. It's held between 15% and 90% of the crown height so both halves stay real panels.",
  tent_shoulder_w_m:"<b>How far the tent bulges out at that fold</b> — the shoulder. This is what makes a modern tent feel like a room instead of a wedge: the walls swell outward at elbow height and then tuck back in above. Widen it for a rounder, roomier bell. It won't go below the straight line from floor to ceiling — narrower than that isn't a shoulder, it's a dent, and the wall would start cutting the ceiling away.",
  tent_gable_bevel:"<b>How much the end walls fold into a prow.</b> 0 = one flat wall straight across the end. Turn it up and the end becomes two panels meeting at a vertical crease down the middle, so the far end points gently away from you and catches light on its two halves differently — the shape a real tent's foot end has, and the crease your eye follows down to the floor.",
  ...
  tent_end_lean:"<b>How much the end walls lean outward as they drop.</b> 0 = flat vertical walls at each end, like a box. Up = the ends splay out toward the floor the way a real tent's fly does, so the far wall reads as a leaning plane rather than a painted backdrop.",
  ...
  tent_seam:"<b>The dark taped seams where the panels meet.</b> 0 = none, the whole tent is one continuous sheet. Turn it up and every junction draws — the two long edges of the crown running away from you, the rims where the end walls meet the roof. It's the strongest cue that you're inside a made object of flat panels and not a smooth painted shell.",
