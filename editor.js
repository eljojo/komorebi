...
const TIPS = {
  ...
  receiver:"<b>What surface the light lands on.</b> <i>Floor</i> — the light reflects off the ground (every existing look; unchanged). <i>Curtain</i> — the light passes THROUGH a translucent woven moss-velvet curtain, lit from behind, the way sunset glows through a bedroom drape. (Shipped so far: transmission, the standing-plane projection, the drape folds, the velvet sheen and the window mullion grid. Still to come: the forward-scatter glow and the fold warp of the cast pattern.)",
