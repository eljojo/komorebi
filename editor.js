...
const TIPS = {
  ...
  receiver:"<b>What surface the light lands on.</b> <i>Floor</i> — the light reflects off the ground (every existing look; unchanged). <i>Curtain</i> — the light passes THROUGH a translucent woven moss-velvet curtain, lit from behind, the way sunset glows through a bedroom drape. (First step of the curtain scene — transmission only so far; window grid, folds and the velvet sheen come next.)",
