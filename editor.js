...
const PANEL = [
  ...
  ['s','fabric_tt','fabric Tt',0,1,0.01,''],
  ['s','fabric_tint_r','moss R',0,1,0.01,''],
  ['s','fabric_tint_g','moss G',0,1,0.01,''],
  ['s','fabric_tint_b','moss B',0,1,0.01,''],
  ['s','cloth_distance_m','cloth dist',-20,20,0.1,''],
  ...
  ['s','fabric_scatter','pile scatter',0,1,0.01,''],
  ['s','glow_bleed','glow bleed',0,1,0.01,''],       // THE GATE (§4.9): >0 routes the frame through linear HDR + two blur passes + a compositing tone-map
  ['s','glow_bleed_m','bleed (m)',0,0.2,0.005,''],   // how far the weave carries the light, in cloth metres
...
const TIPS = {
  ...
  fabric_tt:"<b>How much light the curtain lets through (its brightness).</b> Low = a thick dark velvet that only the hottest dapples punch through; high = a thin sheer the sun floods. Brightness only — the colour is set separately below, so a dark green velvet stays dark instead of glowing.",
  fabric_tint_r:"<b>How much RED the curtain dye passes.</b> Keep it low for moss — the dye drinks red, leaving the green. Only the hue matters here; the overall brightness is the Tt knob above.",
  fabric_tint_g:"<b>How much GREEN the curtain dye passes.</b> High for moss velvet — green is what leaks through, so the body of the curtain glows green-gold against the sunset.",
  fabric_tint_b:"<b>How much BLUE the curtain dye passes.</b> Low for moss. Nudge it for a cooler or warmer green.",
  cloth_distance_m:"<b>How far the curtain hangs from the tree.</b> The curtain is a standing wall; this slides it nearer or further along the ground, which — together with the sun's angle — sets where the tree's shadow lands on the cloth. Nudge it (with the sun angle and the pan) to frame the shadow on the curtain.",
